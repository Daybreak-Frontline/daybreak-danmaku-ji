...
const props = withDefaults(
  defineProps<{
    ...
    chatMessages?: ParticleChatMessage[];
    chatEnabled?: boolean;
  ...
  }>(),
  {
    snapshot: () => ({
      ...
      state: { queue: [], history: [], randomPlayback: false }
    }),
    chatMessages: () => [],
    embedded: false,
    roomControls: false,
...
function chatAvatar(message: ParticleChatMessage) {
...
function createCardTexture(
  item: ParticleTrack | null | undefined,
  tag: string,
  index: number,
